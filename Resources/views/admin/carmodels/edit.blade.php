...
@section('content')
    {!! Form::open(['route' => ['admin.carrental.carmodel.update', $carmodel->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">

                <div class="tab-content">
                    @include('carrental::admin.carmodels.partials.edit-fields')
