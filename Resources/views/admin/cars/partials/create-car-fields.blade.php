<div class="box-body form-horizontal">
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {!! Form::text('plate_no', old('plate_no'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.plate_no')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {!! Form::text('model_year', old('model_year'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.model_year')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {!! Form::text('chassis_no', old('chassis_no'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.chassis_no')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {!! Form::text('motor_no', old('motor_no'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.motor_no')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    {!! Form::text('current_km', old('current_km'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.current_km')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    {!! Form::text('max_km', old('max_km'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.max_km')]) !!}
                    <div class="input-group-addon">km</div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    {!! Form::text('period_km', old('period_km'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.period_km')]) !!}
                    <div class="input-group-addon">km</div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                {!! Form::text('identity_no', old('identity_no'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.identity_no')]) !!}
                {!! $errors->first("identity_no", '<span class="help-block">:message</span>') !!}
            </div>
            <div class="col-sm-4">
                {!! Form::text('tax_no', old('tax_no'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.tax_no')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                {!! Form::text('license_key', old('license_key'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.license_key')]) !!}
                {!! $errors->first("license_key", '<span class="help-block">:message</span>') !!}
            </div>
            <div class="col-sm-4">
                {!! Form::text('license_no', old('license_no'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.license_no')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    {!! Form::text('licensed_at', old('licensed_at'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.licensed_at')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    {!! Form::text('current_fuel', old('current_fuel'), ['class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.current_fuel')]) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                {!! Form::textarea('description', old('description'), ['rows'=>3, 'class'=>'form-control', 'placeholder'=>trans('carrental::cars.form.description')]) !!}
